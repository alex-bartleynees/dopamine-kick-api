...
/// <summary>
/// Resolves the caller's customer and runs a full resync. Called by the /success redirect handler
/// before showing "you're subscribed", closing the race where the browser beats Stripe's webhook.
/// </summary>
public record SyncSubscription(Guid UserId) : IRequest<Result>;
